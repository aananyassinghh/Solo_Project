...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\anany\\Desktop\\lab_project\\SoloProject_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome!\n\nIn this experiment you will be shown a maze with three endpoints marked as 'A', 'B', 'C'.\nThere are two levels - \nLevel 1 consists of square - shaped mazes. \nLevel 2 consists of Triangle - shaped mazes. \nTo answer press the letter key of the answer you choose. \nIf you wish to continue with this experiment press 'spacebar', if not press 'esc'. ",
        font='Arial',
    ...
    introductionComponents = [text, key_resp_3]
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('Image sheet.xlsx', selection='0:10'),
    ...
    for thisTrial in trials:
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        phase_1Components = [fixation, image, key_resp]
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['a','b','c'], ignoreKeys=["escape"], waitRelease=False)
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('break_3.started', globalClock.getTime(format='float'))
    # create starting attributes for key_resp_4
    key_resp_4.keys = []
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    break_3Components = [text_2, key_resp_4]
    ...
    for thisComponent in break_3Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('break_3.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Image sheet.xlsx', selection='10:20'),
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        phase_2Components = [fixation_2, image_2, key_resp_2]
        ...
        while continueRoutine:
            ...
            if key_resp_2.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_2.getKeys(keyList=['a','b','c'], ignoreKeys=["escape"], waitRelease=False)
